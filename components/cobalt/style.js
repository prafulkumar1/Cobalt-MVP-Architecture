...
export const styles = StyleSheet.create({
  ...
  floatingBtn:{  width: 72,height: 72,backgroundColor: "#FF6F00",borderRadius: 11 },
  cartCountTxt:{  position: "absolute",bottom: 34,color: "#FFFFFF",fontSize: 27,overflow: "hidden", fontFamily:"SourceSansPro_SemiBold",height:responsiveHeight(3), paddingTop:5},
