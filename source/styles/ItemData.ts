...
export const styles = StyleSheet.create({
    ...
    rightItemContainer:{ flexDirection: 'row', alignItems: 'center',width:responsiveWidth(24),justifyContent:"space-between",marginRight:responsiveWidth(8)},
    addIconBtn:{ 
        flexDirection: 'row', 
        alignItems: 'center',
    ...
    itemMainContainer:{ flex: 1,borderRadius:20,marginTop:responsiveHeight(5.5) },
