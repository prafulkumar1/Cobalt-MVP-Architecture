...
export const styles = StyleSheet.create({
    ...
    fixedNameComp: {
        ...
        elevation: 5,
        zIndex: 100,
        flexDirection: 'row', paddingRight: 30, paddingLeft: 20
    },
    ...
    modifierContainer: { paddingHorizontal: 7, width: "100%", backgroundColor: "#fff", borderTopLeftRadius: 30, borderTopRightRadius: 30 },
    itemMainContainer: { flex: 1, borderTopRightRadius: 35, borderTopLeftRadius: 35 },
