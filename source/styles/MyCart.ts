...
export const styles = StyleSheet.create({
  ...
  modalContainer: {flex: 1, position: 'absolute',top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.9)'},
  ...
  innerModalAlertTxt: { fontSize: 24, color: "#4B5154", fontFamily: "SourceSansPro_SemiBoldItalic", textAlign: 'center', width: responsiveWidth(100), paddingVertical: 5, marginTop: responsiveHeight(5), lineHeight: 30 },
  ...
  innerModal: {width: '100%',backgroundColor: "#fff",height: responsiveHeight(68),padding: 20,justifyContent: 'space-between',borderRadius: 10},
  ...
  thankMsg:{fontSize:responsiveFontSize(4), color:"#5773A2", fontFamily: "SourceSansPro_Bold", marginTop:responsiveHeight(5), lineHeight:50},
  ...
  footerContainer: { backgroundColor: "#fff", width: "100%", height: 80, position: "absolute", bottom: 0, right: 0, left: 0, flexDirection: "row",justifyContent: "space-between", alignItems: "center", borderTopWidth: 1, borderColor: "#ccc",  paddingHorizontal: 20},
  ...
  addToCartBtn2: { backgroundColor: "#5773a2", width:responsiveWidth(40), height:responsiveHeight(5),borderRadius: 20, justifyContent: "center", alignItems: "center"},
  addCartTxt: { color: "#fff",fontSize: 22,fontFamily: "SourceSansPro_SemiBold",textAlign: "center",paddingTop:10},
}); 