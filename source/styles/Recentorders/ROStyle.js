...
export const styles = StyleSheet.create({
  ...
  statusValTxt:{ marginLeft: "auto", color: "#FF6F00", fontSize: 16, fontFamily: "SourceSansPro_SemiBold", right: 15 },
  statusCompelete:{ marginLeft: "auto", color: "#FF6F00", fontSize: 16, fontFamily: "SourceSansPro_SemiBold", },
  ...
  labelPickUpTime:{ fontSize: 10, color: "#4F4F4F", fontFamily: "SourceSansPro_SemiBoldItalic", },
  pickValue:{ fontSize:18, fontFamily: "SourceSansPro_SemiBold", color: "#2A4E7D" },
  pickUpLocation:{ fontSize:16, fontFamily: "SourceSansPro_SemiBold", color: "#2A4E7D",width:responsiveWidth(29) },
  compPickUpLocation:{ fontSize:18, fontFamily: "SourceSansPro_SemiBold", color: "#2A4E7D",width:responsiveWidth(55)},
  ...
  labelQty:{ fontSize: 14, color: "#5773A2", fontFamily: "SourceSansPro_SemiBoldItalic",  marginRight: isPlatformAndroid()?25:35,},
  labelAmount:{ fontSize: 14, color: "#5773A2", fontFamily: "SourceSansPro_SemiBoldItalic",right:isPlatformAndroid()?5:10 },
  ...
  priceContainer: { flexDirection: "row",alignItems: "center",justifyContent: "flex-end"},
