...
export default function FoodOrderScreen() {
                  ...
                  dinner_sub_category_data: [
                    {
                      ...
                      price: "$15.00",
                      dish_description:
                        "A warm and rich chocolate cake with a gooey center.",
                      is_subcategroy_item_open: false,
                      image:
                        "https://images.pexels.com/photos/410999/pexels-photo-410999.jpeg?cs=srgb&dl=pexels-pixabay-410999.jpg&fm=jpg",
                      is_dish_available: true,
                    },
                  ],
                },
    ...
    return (
      <UI.HStack>
        ...
        >
          ...
          {
            item.is_lunch_recepies_category_selected && 
  ...
  return (
    <UI.ScrollView contentContainerStyle={styles.scrollContent}>
        <UI.cbFlatList
          flatlistData={foodOrderData[1].meal_category[1].meal_type_category}
          children={renderListItem}
          horizontal={true}
          contentContainerStyle={styles.categoryBottomContainer}
        />
        <UI.cbAccordion AccordionData={foodOrderData} />
    </UI.ScrollView>
  );
}
